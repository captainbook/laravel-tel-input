...
(function () {
  ...
  function initTelInput(telInput) {
            ...
            if (itiPhone.isValidNumber() === false) {
              ...
              phoneInput.dispatchEvent(new CustomEvent('telchange', {
                detail: {
                  ...
                  validNumber: phoneInput.value,
                  number: itiPhone.getNumber(),
                  country: (_itiPhone$getSelected3 = itiPhone.getSelectedCountryData().iso2) === null || _itiPhone$getSelected3 === void 0 ? void 0 : _itiPhone$getSelected3.toUpperCase(),
                  countryName: itiPhone.getSelectedCountryData().name,
                  dialCode: itiPhone.getSelectedCountryData().dialCode
                }
              }));
              ...
              if (window.Livewire) {
                ...
                Livewire.dispatch('telchange', {
                  detail: {
                    ...
                    validNumber: phoneInput.value,
                    number: itiPhone.getNumber(),
                    country: (_itiPhone$getSelected4 = itiPhone.getSelectedCountryData().iso2) === null || _itiPhone$getSelected4 === void 0 ? void 0 : _itiPhone$getSelected4.toUpperCase(),
                    countryName: itiPhone.getSelectedCountryData().name,
                    dialCode: itiPhone.getSelectedCountryData().dialCode,
                    phoneInputId: this.dataset.phoneInput.replace('#', '')
                  }
    ...
    if (telInput.dataset.phoneCountryInput) {
      ...
      if (phoneCountryInput) {
        ...
        phoneCountryInput.removeEventListener('change', _changeHandler);
        phoneCountryInput.addEventListener('change', _changeHandler);
      }
  ...
  document.addEventListener("DOMContentLoaded", function () {
    setTimeout(function () {
      renderTelInput();
    }, 5); // user dispatched browser events to re-render the tel inputs
    ...
    if (window.Livewire) {
      window.Livewire.hook('component.initialized', function (component) {
        setTimeout(function () {
          renderTelInput();
        }, 5);
      });
