...
(function () {
  ...
  function initTelInput(telInput) {
    ...
    itiPhone.setNumber(telInput.dataset.phoneInputPhoneValue); // countrychange event function
    ...
    telInput.addEventListener('input', telInputChangeEventFunc); // listen and sync phone number with tel input if any
  ...
  document.addEventListener("DOMContentLoaded", function () {
    renderTelInput(); // user dispatched browser events to re-render the tel inputs
    ...
    if (window.Livewire) {
      window.Livewire.hook('element.initialized', function (el, component) {
